...
class Customer(db.Model):
    ...
    def __repr__(self):
        return f'User: cust_id={self.cust_id} Name={self.last_name, self.first_name} Company={self.company}'
...
class AdvRep(db.Model):
    ...
    rep_id = db.Column(db.Integer, db.ForeignKey("users.id"))
    adv_id = db.Column(db.Integer, db.ForeignKey("users.id"))

    sales_rep = db.relationship("User", backref="adv_rep_relationships")
    sales_adv = db.relationship("User", backref="adv_rep_relationships")
...
class Meeting(db.Model):
    ...
    sales_rep = db.relationship("User", backref="meetings")
    sales_adv = db.relationship("User", backref="meetings")
